...
public interface EduService {
    ...
    //학습그룹 가입승인조회
    ArrayList<JoinGroupVO> myJoinGroup(ShowCriteria cri, String userId, GroupSearchVO searchVO);
    ...
    /////////////////////////컨텐츠
    //내콘텐츠 조회
    List<ContentVO> selectMyContents(ShowCriteria cri, String userId, GroupSearchVO searchVO);
