...
import com.project.cep.handler.CustomRememberMeHandler;
import com.project.cep.handler.CustomSuccessHandler;
...
//		.addFilter(new CustomLoginFilter(authenticationManager));
	...
	public AuthenticationSuccessHandler GoogleSuccessHandler() {
		return new	com.project.cep.handler.GoogleSuccessHandler();
	}
