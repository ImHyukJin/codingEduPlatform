package com.project.cep.controller.student;
...
import com.project.cep.service.student.StudentService;
...
public class StudentController {
    ...
    @GetMapping("/apply")
    public String apply(Principal principal, GroupSearchVO searchVO, ShowCriteria cri, Model model) {
