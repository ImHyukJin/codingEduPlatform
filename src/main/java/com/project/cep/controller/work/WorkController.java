package com.project.cep.controller.work;
...
import com.project.cep.dto.work.PageeeVO;
...
import com.project.cep.service.work.WorkService;
...
public class WorkController {
    ...
    @GetMapping("/workdis")
    public String list(Model model, AmountCriteria cri, Authentication authentication, GroupSearchVO searchVO) {
    ...
    @GetMapping("/workdel")
    public String list3(Model model, AmountCriteria cri, Authentication authentication) {
        MyUserDetails dd = (MyUserDetails)authentication.getPrincipal();
    ...
    public String list2(Model model, AmountCriteria cri, Authentication authentication) {
        MyUserDetails dd = (MyUserDetails)authentication.getPrincipal();
