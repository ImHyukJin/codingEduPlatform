package com.project.cep.controller.edu;
...
import com.project.cep.service.edu.EduService;
import com.project.cep.service.edu.PageVO;
...
public class EduController {
	...
	public String groupJoin(Principal principal, Model model, ShowCriteria cri, GroupSearchVO searchVO){
		String user_id = principal.getName();
		System.out.println(searchVO);
		if(cri.getCurrentPage() == null || cri.getShowPage() == null){
			cri = new ShowCriteria();
		}
	...
	public String groupContents(Principal principal, Model model, ShowCriteria cri, GroupSearchVO searchVO){
		String user_id = principal.getName();
		if(cri.getCurrentPage() == null || cri.getShowPage() == null){
			cri = new ShowCriteria(1,5);
		}
